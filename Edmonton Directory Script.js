function addSearchbox(){
	...
	var ab_link = "http://www.bbb.org/edmonton/accredited-business-directory";
	...
	if (typeof(div_ab) != 'undefined' && div_ab != null){
		...
		//txt_loc.setAttribute('value', 'Edmonton, AB');
		...
		//txt_loc.setAttribute('onblur', 'if(this.value == "") {this.value="Edmonton, AB"};');
                //txt_loc.setAttribute('onfocus', 'if(this.value === "Edmonton, AB") {this.value=""};');
                                txt_loc.setAttribute('placeholder', 'Edmonton, AB');
...
function searchAB(type){
	...
	var default_location = "Edmonton, AB";
	...
	var ab_url = "http://www.bbb.org/edmonton/accredited-business-directory";
	var search_url = "http://www.bbb.org/edmonton/accredited-business-directory/find/?s=" + tob + "&loc=" + loc;
	var search_old_url = "http://www.bbb.org/edmonton/customer-reviews/searcholddirectory.php?key=" + tob + "&loc=" + loc;
